...
public class Main {
    public static void main(String[] args) {
        ...
        // Adicionando uma música ao banco de músicas e realizando a persistência em DadosMusicas através do ID //
        // Duração é recebida como inteiro e printa a conversão como minutos e segundos // 
        BancoMusicas.addMusica(new MusicaCancao("Garota de Ipanema", "02/08/1962", "Tom Jobim", "MPB",321, "Olha que coisa mais linda, mais cheia de graça"));
        BancoMusicas.addMusica(new MusicaInstrumental("Requiem", "05/06/1971","Mozart", "Clássica", 400, "ré menor"));
        bancoMusicas.saveMusicas();
        bancoMusicas.readMusicas();
        System.out.println(BancoMusicas.getById(0).getData());
        System.out.println(BancoMusicas.getById(1).getDuracao());
        
        // Criando o Banco de usuários e criando os usuários //

        UsuarioComum user = new UsuarioComum("Renan", "renanmali", "151021");
        UsuarioAdmin userAdm = new UsuarioAdmin("Ana Carolina", "carolinazz", "838201");
        BancoUsuarios bancoUsuarios = new BancoUsuarios("My_list");
        ...
        // Criando uma playlist para o usuário comum //

        user.createPlaylist("MPB");
